...
## 📊 Исходные данные
В проекте используется популярный датасет **Mall Customer Segmentation Data**, взятый с платформы [Kaggle Dataset Source](https://kaggle.com).
...
### 2. ⭐ Кластер №0: «Целевая аудитория» (VIP-клиенты)
